...
import GitHubFolderTreeView from "@/components/dialogs/code/configureProjectDialog/github-folder-tree-view";

type GitHubFolderSelectionPopupProps = {
  repo: GitHubRepo,
...
export default function GitHubFolderSelectionPopup({
  repo,
  selectedPaths,
  onSelectionChange,
  onClose,
  branch,
}: GitHubFolderSelectionPopupProps) {
  return (
